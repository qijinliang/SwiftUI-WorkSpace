...
struct Path2: View {
    var body: some View {
        ZStack() {
            ...
            Path() { path in
                path.move(to: CGPoint(x: 5, y: (width / 2) + 400))
                path.addLine(to: CGPoint(x: 5, y: width - 100))
                path.addLine(to: CGPoint(x: width - 5, y: width - 100))
                path.addLine(to: CGPoint(x: width - 5, y: (width / 2) + 400))
            ...
            Path() { path in
                path.move(to: CGPoint(x: 20, y: (width / 2) + 380))
                path.addLine(to: CGPoint(x: 20, y: width - 80))
                path.addLine(to: CGPoint(x: width - 20, y: width - 80))
                path.addLine(to: CGPoint(x: width - 20, y: (width / 2) + 380))
            ...
            Path() { path in
                path.move(to: CGPoint(x: 35, y: (width / 2) + 360))
                path.addLine(to: CGPoint(x: 35, y: width - 60))
                path.addLine(to: CGPoint(x: width - 35, y: width - 60))
                path.addLine(to: CGPoint(x: width - 35, y: (width / 2) + 360))
            ...
            Path() { path in
                path.move(to: CGPoint(x: 50, y: (width / 2) + 340))
                path.addLine(to: CGPoint(x: 50, y: width - 40))
                path.addLine(to: CGPoint(x: width - 50, y: width - 40))
                path.addLine(to: CGPoint(x: width - 50, y: (width / 2) + 340))
            ...
            Path() { path in
                path.move(to: CGPoint(x: 65, y: (width / 2) + 320))
                path.addLine(to: CGPoint(x: 65, y: width - 20))
                path.addLine(to: CGPoint(x: width - 65, y: width - 20))
                path.addLine(to: CGPoint(x: width - 65, y: (width / 2) + 320))
